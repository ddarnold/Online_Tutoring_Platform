...
public interface UserService {
   ...
   * @return the {@link UserDBO} object if found
   * @throws IllegalArgumentException if {@code userId} is null
   */
  UserBaseDTO findByUserId(Long userId);

  /**
   * Retrieves a {@link UserDBO} entity representing a tutor by their unique identifier.
   *
   * @param tutorId the unique identifier of the tutor to be retrieved
   * @return the {@link UserDBO} entity corresponding to the specified tutor ID, or {@code null} if
