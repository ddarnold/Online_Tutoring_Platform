...
public class CourseController {
     ...
     * This endpoint is cross-origin enabled for requests from "http://localhost:3000"
     * and allows preflight requests to be cached for up to 3600 seconds.
     *
     ...
     * Allows cross-origin requests from "http://localhost:3000" with a maximum age of 3600 seconds.
     *
