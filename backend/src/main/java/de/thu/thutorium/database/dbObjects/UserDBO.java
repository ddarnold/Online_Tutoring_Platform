...
public class UserDBO {
   ...
   * resolved into another table, in order to not violate the database normalization principles.
   */
   ...
   *
   * <p>Defines a one-to-many relationship with {@link MessageDBO}. The {@code orphanRemoval}
   * attribute is set to 'false' to archive the messages.
   */
  @OneToMany(
      mappedBy = "sender",
  ...
  private Set<CourseDBO> createdCourses;
}
